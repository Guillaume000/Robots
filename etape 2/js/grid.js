        ...
        while(gridElements.length < configElements) {
            ...
            if(!this.occupiedCells.includes(chanceIndex)) {
                ...
                if(elements === "robots") {
                    ...
                    var gridObject = new Robot(robotElement.name, robotElement.lifePoints, robotElement.mobility, robotElement.weapon, robotElement.position, {a: parseInt(chanceIndex[0]), b: parseInt(chanceIndex[1])});
                    gridElements.push(gridObject);
